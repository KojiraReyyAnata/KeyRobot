...
import Key.modules.sql.connection_sql as sql
from Key import dispatcher, DRAGONS, DEV_USERS
from Key.modules.helper_funcs import chat_status
...
def connection_chat(update, context):
    ...
    if conn:
        message = f"Anda saat ini terhubung ke {chat_name}.\n"
    else:
            ...
            if connection_status := sql.connect(
                ...
                try:
                    ...
                    context.bot.send_message(
                        update.effective_message.from_user.id,
                        f"Anda terhubung ke *{chat_name}*. \nGunakan `/helpconnect` untuk memeriksa perintah yang tersedia.",
                        parse_mode="markdown",
                    )
