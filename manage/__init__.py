...
def get_user_list(__init__, key):
    with open(f"{os.getcwd()}/Key/{__init__}", "r") as json_file:
...
LOGGER.info("K is starting. | An Key Robot Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/ (t.me/Pusingeaak)")
...
if ENV:
    ...
    JOIN_LOGGER = os.environ.get("JOIN_LOGGER", "-1001905557194")
    ...
    ERROR_LOGS = os.environ.get("ERROR_LOGS", -1001986858575)
    ...
    from Key.Config import Development as Config
...
from Key.modules.helper_funcs.handlers import (
