...
from Key.modules.helper_funcs.decorators import Keycmd, Keymsg
from Key.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from Key.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@Keycmd(command="antich", group=100)
...
@Keymsg(Filters.chat_type.groups, group=110)
