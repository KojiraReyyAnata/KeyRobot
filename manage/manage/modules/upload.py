...
from Key import telethn as bot
from Key.modules.urluploader import download_file
from Key.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @KeyRobot",
            )
        except Exception as e:
            traceback.print_exc()
