...
from NayaMusic.utils import get_readable_time
from NayaMusic.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from NayaMusic.utils.decorators.language import language

# Command
GBAN_COMMAND = get_command("GBAN_COMMAND")
UNGBAN_COMMAND = get_command("UNGBAN_COMMAND")
GBANNED_COMMAND = get_command("GBANNED_COMMAND")
UPGRADE_COMMAND = get_command("UPGRADE_COMMAND")
...
@app.on_message(filters.command(UPGRADE_COMMAND) & SUDOERS)
async def the_reboot(client, message):
     await message.delete() 
     os.system("git pull")
     os.execl(sys.executable, sys.executable, "-m", "NayaMusic")