...
from NayaMusic import YouTube, app
from NayaMusic.core.userbot import assistants
from NayaMusic.misc import SUDOERS, mongodb
from NayaMusic.plugins import ALL_MODULES
from NayaMusic.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from NayaMusic.utils.decorators.language import language, languageCB
from NayaMusic.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
...
**Storage Avail:** {str(total)[:4]} GiB
**Storage Used:** {str(used)[:4]} GiB
**Storage Left:** {str(free)[:4]} GiB
**Served Chats:** {served_chats} 
**Served Users:** {served_users} 
**Blocked Users:** {blocked} 
**Sudo Users:** {sudoers} 
**Total DB Size:** {str(datasize)[:6]} Mb
**Total DB Storage:** {storage} Mb
**Total DB Collections:** {call["collections"]}
**Total DB Keys:** {call["objects"]}
    """
    med = InputMediaPhoto(media=config.STATS_IMG_URL, caption=text)
    try:
        await CallbackQuery.edit_message_media(
