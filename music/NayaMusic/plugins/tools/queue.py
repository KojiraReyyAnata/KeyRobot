...
from NayaMusic.utils import (Ayabin, get_channeplayCB,
                              seconds_to_min)
from NayaMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from NayaMusic.utils.decorators.language import language, languageCB
from NayaMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph//file/9b225928deaee7c856fd0.jpg",
        caption=_["queue_1"],
    )
