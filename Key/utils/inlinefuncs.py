...
from Key import arq
from Key.services.keyboard import Ikb
from Key.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Key.services.tasks import _get_tasks_text, all_tasks, rm_task
from Key.services.types import InlineQueryResultCachedDocument
from Key.modules.info import get_chat_info, get_user_info
from Key.modules.music import download_youtube_audio
from Key.utils.functions import test_speedtest
from Key.utils.pastebin import paste
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [ᴋᴇʏ](t.me/Pusingeaak)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
