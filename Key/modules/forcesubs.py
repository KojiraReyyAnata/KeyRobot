...
from Key import DRAGONS as SUDO_USERS
from Key import pbot
from Key.modules.sql import forceSubscribe_sql as sql
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        f"Welcome {message.from_user.mention} 🙏 \n **Anda belum bergabung dengan kami @{channel} channel belum**👷 \n \nSilahkan Bergabung [Saluran kami](https://t.me/{channel}) dan tekan **UNMUTE ME** Tombol. \n \n ",
        ...
        if len(message.command) > 1:
            ...
            if input_str.lower() in ("off", "no", "disable"):
                ...
                try:
                    ...
                    message.reply_text("❗ **Nama Pengguna Saluran Tidak Valid.**")
...
__help__ = """
*Force Subscribe:*
⩺ Key dapat membisukan anggota yang tidak berlangganan saluran Anda sampai mereka berlangganan
