...
from Key.modules.helper_funcs.msg_types import Types
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} Minimal Saling Rep chat biar saling Aw Aw Aw 😍",
    "{first} baru saja bergabung dengan obrolan - asdgfhak!",
    "{first} baru bergabung. Semuanya, terlihat sibuk!",
    "Welcome, {first}. Jadilah orang pertama untuk menemaniku.",
    "Welcome, {first}. Kami mengharapkanmu ( ͡° ͜ʖ ͡°)",
    "Welcome, {first}. Kami harap Anda bukan maling korek di tongkrongan.",
    "Welcome, {first}. Tinggalkan dia yang sudah tidak sayang denganmu ☺.",
    "Ka. {first} Gimana kita 📞 .",
    "Kuatkan dirimu. {first} karena di sini banyak bermuka babi seperti dirimu 🐷.",
    "{first} baru bergabung. Sembunyikan pisangmu, banyak wanita penjilat yang suka pisang 🗿.",
    ...
    "welcome, {first} kalo bantuan chat admin group ok✨.",
    ...
    "Hai! dengarkan! chat @Galau912 jika membutuhkan Teleprem dan userbot {first} telah bergabung!",
    "Kamu Sangean!!! {first}",
    ...
    "{first} sayang cek @Geninstore jika membutuhkan Nokos.",
