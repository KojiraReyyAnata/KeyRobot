...
import Key.modules.sql.global_bans_sql as sql
from Key.modules.sql.users_sql import get_user_com_chats
from Key import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Key.modules.helper_funcs.misc import send_to_list
